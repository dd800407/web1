	...
	<?php
				...
				die("無法使用資料庫<br>");
					...
					while($row = mysqli_fetch_row($result))
						{
						if($member_username==$row[1] && $member_password==$row[2] && $row[2]!=1)
							{
							$id   = $row[0];
							$name = $row[1];
							break;
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          ...
                          <li class="nav-item">
                            ...
                            <li>
						        <a class="nav-link" href="../../oinin/index.php">參加活動</a>
                            </li>						
                          </ul>
                          <!--
			...
			<div class='container'>
				<div class='row'>
					<div class='col-md-12 text-center'>
						<h1 style="font-size: 40px; color: #613030">留言板</h1>					
				</div>
			</div>
    	</section>
		...
		<div class='container'>
			<div class="row">
				<div class='col-md-12 text-center'>
					...
					<form action ="run.php" method ="post" name="log"> 
