			...
			<div class='container'>
				<div class='row'>
					<div class='col-md-12 text-center'>
						<h1 style="font-size: 40px; color: #613030">火車站留言板</h1>					
				</div>
			</div>
    	</section>
		...
		<div id="myCarousel" class="carousel slide">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img class="d-block w-100" src="../pictures/train1.jpg" alt="First slide">
				...
				<div class="item">
					<img class="d-block w-100" src="../pictures/train2.jpg" alt="Second slide">
				</div>
				<div class="item">
					<img class="d-block w-100" src="../pictures/train3.jpg" alt="Third slide">
				</div>
			</div>
			<!-- 輪播控制 -->
		...
		<div class='container'>
			<div class="row">
				<div class='col-md-12 text-center'>
					...
					<form action ="run9.php" method ="post" name="log"> 
